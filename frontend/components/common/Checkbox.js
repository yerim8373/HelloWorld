      ...
      <div className={classes.boxContainer}>
        ...
        <div className={classes.visibleBox}>
          ...
          <svg width="21" height="16" viewBox="0 0 21 16" xmlns="http://www.w3.org/2000/svg" className={`${classes.checkIcon} ${checkState && classes.checked}`}>
            <path fillRule="evenodd" clipRule="evenodd" d="M7 11.4286L2.33333 6.85714L0 9.14286L7 16L21 2.28571L18.6667 0L7 11.4286Z" />
          </svg>
          <label htmlFor={id} className={classes.clickArea}></label>
        </div>
